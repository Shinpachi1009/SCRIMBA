<nav class="bg-gray-800">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="rounded-md <?= urlIs('/') ? 'bg-gray-900' : 'text-gray-300'?> px-3 py-2 text-sm font-medium text-white">Home</a>
                        <a href="/about" class="rounded-md <?= urlIs('/about.php') ? 'bg-gray-900' : 'text-gray-300'?> px-3 py-2 text-sm font-medium text-white">About</a>
                        <a href="/notes" class="rounded-md <?= urlIs('/notes.php') ? 'bg-gray-900' : 'text-gray-300'?> px-3 py-2 text-sm font-medium text-white">notes</a>
                        <a href="/link" class="rounded-md <?= urlIs('/link.php') ? 'bg-gray-900' : 'text-gray-300'?> px-3 py-2 text-sm font-medium text-white">link</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
    ...
    <div id="mobile-menu" class="md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="/" aria-current="page" class="<?php if ($_SERVER['REQUEST_URI'] === '/index')?>rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Home</a>
            ...
            <a href="/controllers/link.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">link</a>
        </div>
